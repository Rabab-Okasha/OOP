...
int main() {
    ...
    sav_accounts.push_back(Saving_Account {"Marinate"});
    sav_accounts.push_back(Saving_Account {"Alia", 2000});
    sav_accounts.push_back(Saving_Account {"Adrian", 5000, 5.0});
    ...
    //Checking Account
     ...
     check_account.push_back(Checking_Account{"Anna"});
    check_account.push_back(Checking_Account{"Elsa", 2000});
    check_account.push_back(Checking_Account{"Olaf", 5000});
